...
const Products = () => {
  ...
  },[authState.address,contractState.productContract])
  ...
  }, [productIds,authState.address, contractState.manufacturerContract,contractState.productContract])
        ...
        {productIds.length > 0 && Object.keys(products).length === 0 ?
          <div align="center">
            <div className="col-10 col-md-6">
              <img src={fake_product} width="100%" alt="fake_product"/>
              <span>
                No products found
              </span>
            </div>
